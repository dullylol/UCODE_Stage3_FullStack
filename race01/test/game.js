...
function getDeck() {
    return [
        new Card("Iron Man", "./cards/iron_man.jpg", 5, 4, 4),
        new Card("Hulk", "./cards/hulk.jpeg", 10, 10, 8),
        new Card("Thanos", "./cards/thanos.png", 20, 20, 10),
        new Card("Black panther", "./cards/black_panther.jpeg", 3, 4, 3),
        new Card("Captain America", "./cards/captain_america.jpeg", 2, 5, 3),
        new Card("Vanda", "./cards/vanda.png", 20, 6, 5),
        new Card("Black Widow", "./cards/black_widow.jpeg", 2, 1, 1),
        new Card("Thor", "./cards/thor.jpeg", 10, 15, 9),
        new Card("Loki", "./cards/loki.jpeg", 3, 3, 2),
        new Card("Doctor Strange", "./cards/doctor_strange.jpeg", 8, 8, 6),
        new Card("Rocket", "./cards/rocket.jpeg", 5, 1, 6),
        new Card("Star-Lord", "./cards/star_lord.jpeg", 1, 3, 6),
        new Card("Grutt", "./cards/grut.jpeg", 4, 5, 4),
        new Card("Gamora", "./cards/gamora.png", 7, 5, 5),
        new Card("Odin", "./cards/odin.jpeg", 15, 15, 10),
        new Card("Hela", "./cards/hela.jpeg", 14, 14, 10),
        new Card("Spider-man", "./cards/spider_man.jpeg", 6, 7, 5),
        new Card("Captain Marvel", "./cards/captain_marvel.jpeg", 20, 20, 10),
        new Card("Valkyrie", "./cards/valkyrie.jpeg", 5, 4, 4),
        new Card("Nick Fury", "./cards/nick_fury.jpeg", 3, 3, 2)
    ]
}
...
function render() {
    ...
    myField.forEach(element => {
        if (element != null) {
            document.getElementById(`my_field_card${index}`).style.visibility = "visible"
            ...
            document.getElementById(`my_field_card${index}`).style.visibility = "hidden"
        }
        index++
    })
    ...
    myHand.forEach(element => {
        if (element != null) {
            document.getElementById(`my_hand_card${index}`).style.visibility = "visible"
            ...
            document.getElementById(`my_hand_card${index}`).style.visibility = "hidden"
        }
        index++
    })
    ...
    enemyField.forEach(element => {
        if (element != null) {
            document.getElementById(`enemy_field_card${index}`).style.visibility = "visible"
            ...
            document.getElementById(`enemy_field_card${index}`).style.visibility = "hidden"
        }
        index++
    })
    ...
    enemyHand.forEach(element => {
        if (element != null) {
            // document.getElementById(`enemy_hand_card${index}`).style.visibility = "visible"
            ...
            document.getElementById(`enemy_hand_card${index}`).style.visibility = "hidden"
        }
        index++
    })
...
function changeTurn() {
    if (turn == "me") {
        ...
        for (let i = 0; i < myCards.length; i++) {
            if (myCards[i].style.visibility == "visible") {
        ...
        for (let i = 0; i < enemyCards.length; i++) {
            if (enemyCards[i].style.visibility == "visible") {
...
function gameOverFunc() {
    document.getElementById("game_field").style.visibility = "hidden"
